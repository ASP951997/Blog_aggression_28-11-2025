"""
Basic tests for Blog_aggression_28-11-2025 repository
"""
import unittest
import os
...
class TestBasic(unittest.TestCase):
    ...
    def test_license_exists(self):
        ...
        self.assertTrue(os.path.exists('LICENSE'), "LICENSE should exist")
    ...
    def test_license_not_empty(self):
        ...
        if os.path.exists('LICENSE'):
            with open('LICENSE', 'r') as f:
                content = f.read()
                self.assertGreater(len(content), 0, "LICENSE should not be empty")
